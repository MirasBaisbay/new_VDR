...
def process_and_save_structures(pdb_ids):
    ...
    logging.info("Extracting: VDR organism, resolution, space group, unit cell")
...
def main():
    ...
    print("="*70)
    print("Extracts: VDR organisms, resolution, space groups, unit cells")
    ...
    # Download structure files (optional)
